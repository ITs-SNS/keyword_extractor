...
def post():
    ...
    doc_with_newlines = params['content']
    ...
    final_keywords=final_keywords.union(per)
    final_keywords=final_keywords.union(poh)
    final_keywords=final_keywords.union(mss_keywords)
    final_keywords=final_keywords.union(mmr_keywords)

    return {'word': ','.join(list(final_keywords))}
